...
Drop-in Kindle “Read a Sample” popup or new tab for WooCommerce.
When a product’s SKU matches its Amazon ASIN, the plugin auto-outputs a popup or new tab and JS on single product pages. Any link or button pointing to #read-sample-modal will open an embedded Kindle preview for that ASIN.
